...
function() {
    ...
    function cq() {
        return this.x + q + this.y + q + this.width + " Ä‚Â— " + this.height
    }
    ...
    var bo = function(b) {
            if (a.vml) {
                ...
                i.title = "RaphaÄ‚Å¤l Colour Picker", i.style.display = "none", h.doc.body.appendChild(i), bo = bv(function(a) {
                    i.style.color = a;
    ...
    a.getRGB = bv(function(b) {
        ...
        if (k) {
            ...
            if (k[5]) {
                j = k[5][s](W), d = Q(j[0]), j[0].slice(-1) == "%" && (d *= 2.55), e = Q(j[1]), j[1].slice(-1) == "%" && (e *= 2.55), f = Q(j[2]), j[2].slice(-1) == "%" && (f *= 2.55), (j[0].slice(-3) == "deg" || j[0].slice(-1) == "Ã‚Â°") && (d /= 360), k[1].toLowerCase().slice(0, 4) == "hsba" && (h = Q(j[3])), j[3] && j[3].slice(-1) == "%" && (h /= 100);
                return a.hsb2rgb(d, e, f, h)
            }
            if (k[6]) {
                j = k[6][s](W), d = Q(j[0]), j[0].slice(-1) == "%" && (d *= 2.55), e = Q(j[1]), j[1].slice(-1) == "%" && (e *= 2.55), f = Q(j[2]), j[2].slice(-1) == "%" && (f *= 2.55), (j[0].slice(-3) == "deg" || j[0].slice(-1) == "Ã‚Â°") && (d /= 360), k[1].toLowerCase().slice(0, 4) == "hsla" && (h = Q(j[3])), j[3] && j[3].slice(-1) == "%" && (h /= 100);
    ...
    a.findDotsAtSegment = function(a, b, c, d, e, f, g, h, i) {
        ...
        return function() {
            eve("raphael.log", null, "RaphaÄ‚Å¤l: you are calling to method Ã¢Â€Âœ" + a + "Ã¢Â€Â of removed object", a)
        }
    };
    ...
    cl.animateWith = function(b, c, d, e, f, g) {
        ...
        return "RaphaÄ‚Å¤lÃ¢Â€Â™s object"
    };
    var cG = function(a) {
    ...
    var b = "hasOwnProperty",
        ...
        p = {};
    a.toString = function() {
        return "Your browser supports SVG.\nYou are running RaphaÄ‚Å¤l " + this.version
    };
    var q = function(d, e) {
            if (e) {
    ...
    z.prototype = A, A.constructor = z, a._engine.path = function(a, b) {
        ...
        this.bottom = this.top = null, (this.desc = q("desc")).appendChild(a._g.doc.createTextNode("Created with RaphaÄ‚Å¤l " + a.version)), b.appendChild(this.desc), b.appendChild(this.defs = q("defs"))
